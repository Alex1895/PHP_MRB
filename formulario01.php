...
<html>
	...
	<div class="Ingresar"><center>
		...
		<h2 style="color: black; text-align:center;">Notificacion</h2><br>
			</div>
		</div></center>
	</header>
	<div class="Notificacion"><center>
		...
		<option value="-5" selected="selected">Controller Assy</option>
		...
		<option value="-9" selected="selected">Warranty</option>
		<option value="-10" selected="selected">Onestor</option>
		<option value="-11" selected="selected">Talladega</option>
		<option value="-12" selected="selected">Titan</option>
		<option value="-13" selected="selected">Warehouse</option>
        </select><br/>
		<h4 style="color: black; text-align: center;">Part Number</h4> 
        <input aling="center" type="text" size="40" maxlength="255" id="$txtpn" name="pn" value="" /><br/>
		...
		<option value="-2" selected="selected">FA3</option>
		</select><br>
	<h4 style="color: black; text-align: center;">MBD</h4> 
		...
		<option value="-3" selected="selected">Rework local</option>
		<option value="-4" selected="selected">Rework vendor</option>
		<option value="-5" selected="selected">RMAR</option>
		<option value="-6" selected="selected">Scrap</option>
		<option value="-7" selected="selected">OnHold</option>
</br>
		</select>
		</br>
